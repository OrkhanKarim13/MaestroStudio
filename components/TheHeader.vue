  ...
  <div class="text-black w-full bg-white p-4 lg:p-9" :class="{ 'absolute w-full top-0 left-0 z-[50]': menu }">
    <div class="w-full justify-between flex">
      ...
      <div class="relative  flex gap-4 uppercase text-black px-8 py-4">
        <div
          class="cursor-pointer border  md:border md:border-blue-500 md:rounded-full px-4 py-2"
        ...
        <ul
          v-if="isDropdownOpen"
          class="absolute top-14 bg-white border border-gray-300 rounded-lg mt-2 "
        >
          <li
