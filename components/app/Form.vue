<template>
  <div class="grid grid-cols-1 md:grid-cols-2 md:mx-9 md:my-6  md:gap-6">
      <div class="bg-[#0047FF]  px-4 py-6 md:p-12 flex flex-col items-start justify-between  md:rounded-md">
          <div class="w-4/5  text-white text-3xl lg:text-6xl font-bold leading-11">Layihə dəstəyinə ehtiyacınız varmı?
          </div>
          <div class="my-12 flex items-center justify-center ">
            <img src="@/assets/images/arraow_icon.svg" alt="arrow">
          </div>
          <div class="flex flex-col items-start justify-center gap-5">
              <p class="text-white text-lg w-2/3 font-normal">Bizə zəng edin və biz sizə ixtisaslı konsultasiya təqdim edək.</p>
          </div>
      </div>
      <div class=" bg-[#0047FF] px-4 py-6 md:p-12 flex flex-col items-start justify-between gap-6  md:rounded-md">
          ...
          <label
              ...
              for="file">Fayl əlavə edin</label>
          ...
          <p class="w-full px-0 py-5  md:py-5 md:px-8 text-white">Sorğunuzla bağlı sizinlə daha sonra əlaqə saxlamaq üçün şəxsi məlumatlarınız məxfilik siyasətimizə uyğun olaraq işlənəcək.
          </p>
          <button
              class="w-full bg-white uppercase text-black-500 rounded-full font-bold py-5 border yx-8 hover:text-white hover:bg-transparent hover:border-white ">Göndər</button>
      </div>
  </div>
</template>
